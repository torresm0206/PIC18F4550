...
void LCD_Command( unsigned char command)
{
    ...
    I2C_Write((command & 0xF0) | 0b00001000);
    I2C_Write(((command & 0xF0) | 0b00000100) | 0b00001000);
    _delay((unsigned long)((1)*(20000000/4000.0)));
    I2C_Write((command & 0xF0) | 0b00001000);


    I2C_Write((command << 4) | 0b00001000);
    I2C_Write(((command << 4) | 0b00001000) | 0b00000100);
    _delay((unsigned long)((1)*(20000000/4000.0)));
    I2C_Write((command << 4) | 0b00001000);
    I2C_Stop();
...
LCD_Data(unsigned char letra)
{
    ...
    I2C_Write(((letra & 0xF0) | 0b00001000) | 0b00000001);
    I2C_Write((((letra & 0xF0) | 0b00000100) | 0b00001000) | 0b00000001);
    _delay((unsigned long)((1)*(20000000/4000.0)));
    I2C_Write(((letra & 0xF0) | 0b00001000) | 0b00000001);


    I2C_Write((((letra << 4)) | 0b00001000) | 0b00000001 );
    I2C_Write((((letra << 4) | 0b00001000) | 0b00000100) | 0b00000001);
    _delay((unsigned long)((1)*(20000000/4000.0)));
    I2C_Write(((letra << 4) | 0b00001000) | 0b00000001);
    I2C_Stop();
    _delay((unsigned long)((5)*(20000000/4000.0)));
